...
import (
	...
	"gitlab.com/merehead/elloapp/backend/elloapp_tg_backend/app/bff/feeds/internal/core"
...
func TestReadHistory(t *testing.T) {
	...
	*/
	...
	var resp []core.ReadHistoryResp
	if err := json.Unmarshal(data.Data, &resp); err != nil {
		t.Fatal(err)
	}
	logx.Debugf("count messages %d -  %s", len(resp), string(data.Data))
}
