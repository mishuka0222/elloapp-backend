...
import (
	...
	"gitlab.com/merehead/elloapp/backend/elloapp_tg_backend/app/service/biz/account/internal/server/grpc/service"
...
func New(ctx *svc.ServiceContext, c zrpc.RpcServerConf) *zrpc.RpcServer {
	s, err := zrpc.NewServer(c, func(grpcServer *grpc.Server) {
		account.RegisterRPCAccountServer(grpcServer, service.New(ctx))
	})
	logx.Must(err)
	return s
}
