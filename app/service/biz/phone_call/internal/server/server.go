...
import (
	...
	"gitlab.com/merehead/elloapp/backend/elloapp_tg_backend/app/service/biz/phone_call/internal/server/grpc"
...
var configFile = flag.String("f", "etc/phone_call.yaml", "the config file")
